...
$(document).ready(function(){
  ...
  var canvas = document.getElementById('canvas'),
      ...
      // and pass those to our canvas object
      canvas.width = window.innerWidth;
      canvas.height = window.innerHeight;
      // background of our canvas, can be any color
      ctx.fillStyle = "black";
      // x, y, width, height are the params
      ctx.fillRect( 0, 0, canvas.width, canvas.height );

  // We're setting variables that we'll use to update the position of our mouse
  var mouseX = 0,
      mouseY = 0;

  // Track the movement of the user's mouse, and pass the event to update our mouseX and mouseY
  // When we get those values, we'll pass them to our constructor function so that eventually
  // the particles will be generated according to our mouse position
  $(document).mousemove(function(e) {
     mouseX = e.pageX;
     mouseY = e.pageY;
   });

  // A particles object to store our particles
  var particles = {},
